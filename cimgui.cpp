...
CIMGUI_API bool ImGuiSelectionBasicStorage_Contains(ImGuiSelectionBasicStorage* self,ImGuiID key)
{
    return self->Contains(key);
}
CIMGUI_API void ImGuiSelectionBasicStorage_AddItem(ImGuiSelectionBasicStorage* self,ImGuiID key)
{
    return self->AddItem(key);
}
CIMGUI_API void ImGuiSelectionBasicStorage_RemoveItem(ImGuiSelectionBasicStorage* self,ImGuiID key)
{
    return self->RemoveItem(key);
}
CIMGUI_API void ImGuiSelectionBasicStorage_UpdateItem(ImGuiSelectionBasicStorage* self,ImGuiID key,bool v)
{
    return self->UpdateItem(key,v);
}
CIMGUI_API void ImGuiSelectionBasicStorage_ApplyRequests(ImGuiSelectionBasicStorage* self,ImGuiMultiSelectIO* ms_io,int items_count)
{
    return self->ApplyRequests(ms_io,items_count);
}
...
CIMGUI_API bool igBeginBoxSelect(ImGuiWindow* window,ImGuiID box_select_id,ImGuiMultiSelectFlags ms_flags)
{
    return ImGui::BeginBoxSelect(window,box_select_id,ms_flags);
}
CIMGUI_API void igEndBoxSelect(const ImRect scope_rect,bool enable_scroll)
{
    return ImGui::EndBoxSelect(scope_rect,enable_scroll);
}
